    ...
    6 #    Mar 18, 2022 07:37:51 PM EET  platform: Windows NT
    7 
    8 import sys
    9 
   10 try:
   ...
   29     freehost_support.init(root, top)
   30     root.mainloop()
   31 
   32 w = None
   ...
   40     top = Toplevel1 (w)
   41     freehost_support.init(w, top, *args, **kwargs)
   42     return (w, top)
   43 
   ...
   67         self.Button1.place(relx=0.367, rely=0.844, height=34, width=107)
   ...
   76         self.Button1.configure(text='''awardspace''')
   77 
