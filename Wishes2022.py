#! /usr/bin/env python
    ...
    6 #    Dec 30, 2021 07:29:15 PM EET  platform: Windows NT
    7 
    8 import sys
    9 
   10 try:
   ...
   29     wishes2022!!_support.init(root, top)
   30     root.mainloop()
   31 
   32 w = None
   ...
   40     top = Toplevel1 (w)
   41     wishes2022!!_support.init(w, top, *args, **kwargs)
   42     return (w, top)
   43 
   ...
   67         self.Entry1.place(relx=0.067, rely=0.067, height=370, relwidth=0.857)
   ...
   72         self.Entry1.configure(insertbackground="black")
   73 
   74         self.Button1 = tk.Button(top)
   75         self.Button1.place(relx=0.35, rely=0.911, height=34, width=116)
   ...
   84         self.Button1.configure(text='''Button''')
   85 
